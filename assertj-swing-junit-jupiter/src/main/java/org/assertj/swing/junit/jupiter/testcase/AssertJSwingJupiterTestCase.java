...
/**
 * Understands a template for test cases that use AssertJ-Swing and JUnit Jupiter. This template installs a
...
public abstract class AssertJSwingJupiterTestCase extends AssertJSwingTestCaseTemplate {
     ...
     *
     * @throws Exception when the tear down of the test fails which results in that the test will not be cleaned up
     *                   properly
     * @see #cleanUp()
     * @see #onTearDown()
     */
